    ...
    1: [ // Semestre 1
      ...
      },
      {
        ...
        modules: [
          {
            code: "OIRS",
            name: "Éthique et Déontologie informatique/ Outils de rédaction scientifique",
            coeff: 1,
            credit: 1,
            has_td: true,
            has_tp: true,
    ...
    1: [ // Semestre 1 — SID
      ...
      },
      {
        ...
        modules: [
          {
            code: "EDIORS",
            name: "Éthique et Déontologie informatique/ Outils pour la rédaction scientifique",
            coeff: 1,
            credit: 1,
            has_td: true,
            has_tp: true,
    ...
    2: [ // Semestre 2 — SID
      ...
      },
      {
        ...
        modules: [
          {
            code: "BDMED",
            name: "Bases de données multidimensionnelles et entrepôts de données",
            coeff: 3,
            credit: 5,
            has_td: true,
            has_tp: true,
    ...
    1: [ // Semestre 1 — RSID
      ...
      },
      {
        ...
        modules: [
          {
            code: "EDIORS",
            name: "Éthique et Déontologie /Outils pour la rédaction scientifique",
            coeff: 1,
            credit: 1,
            has_td: true,
            has_tp: true,
